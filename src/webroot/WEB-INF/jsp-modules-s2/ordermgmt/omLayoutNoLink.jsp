    ...
    <body>
        ...
        <div id="wrapper" >
          ...
          <div id="mainContent">
            ...
            <table style="border: 6px solid #E2E9F0;">
            <tr>
           <!-- 
			 ...
			 -->
				<td  align="left" style="width: 1000px; background-color: #E2E9F0;">
					<h1 class="headerTitleTop"><s:text name="ordermgmt.top.title"/></h1>
				</td>
			<!-- 
				<td align="right" style="width: 30%; padding-right: 10px;background-color: #F2E9F0;">
