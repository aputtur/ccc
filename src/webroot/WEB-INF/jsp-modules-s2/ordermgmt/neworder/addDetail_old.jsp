...
<s:form action="addDetail" namespace="/om/neworder" method="post">
...
<!-- 
Bundle = <s:property value="bundle.bundleId" /><br/>
Confirm = <s:property value="selectedOrder.confirmation.confirmationNumber" /><br/>
BundleSelected = <s:property value="selectedBundleNumber" /><br/>
ConfirmSelected = <s:property value="selectedConfirmNumber" /><br/>
BundleSearch = <s:property value="searchBundleNumber" /><br/>
ConfirmSarch = <s:property value="searchConfirmNumber" /><br/>
NumberAdedDetails = <s:property value="numAddedDetails" /><br/>
	<br />
	 -->
	<table width="100%">
		...
		<tr id="addDetail">
			<td colspan="2">
				...
				<div style="width: 15%; float: right; padding: 0px; margin: 0px;">
					<s:submit theme="simple" value="Add" onclick="addDetailClient(); return true;"/>
					<s:submit theme="simple" value="Clear All" />
					<s:submit theme="simple" value="Exit" onclick="exitAddDetail(); return false;"/>
				</div>
				<br />
				
				<s:if test="selectedBundleNumber != -1 || selectedBundleNumber == null">
							...
							<table width="100%" class="subTable">
								...
								<tr>
									<s:select cssClass="odd" cssStyle="width: 140px;"
										id="selectProduct" list="productList" listKey="value"
										listValue="label" headerKey="" headerValue="-- Select One --"
										label="Product" name="searchCriteria.productTOU"></s:select>
								</tr>
								<tr>
									<s:select cssClass="odd" cssStyle="width: 140px;"
										id="selectTou" list="touList" listKey="value"
										listValue="label" headerKey="" headerValue="-- Select One --"
										label="Type of Use" name="searchCriteria.productTOU"></s:select>
								</tr>
							</table>
						</td>
						<td width="486px">
					...
					<table width="100%" class="subTable">
						...
						<tr>
							<s:textfield cssClass="odd" cssStyle="width: 680px;"
								label="Title" name="newDetail.title" value="%{newDetail.title}">
								<s:param name="inputcolspan" value="%{3}" />
							</s:textfield>
						</tr>
						<tr>
							<s:textfield cssClass="odd" cssStyle="width: 80px;" label="IDNO"
								name="newDetail.idno" value="%{newDetail.idno}">
							</s:textfield>
							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="Editor" name="newDetail.editor"
								value="%{newDetail.editor}">
							</s:textfield>
						</tr>
						<tr>
							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="Pub Date" name="newDetail.publicationDate"
								value="%{newDetail.publicationDate}">
							</s:textfield>
							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="Volume" name="newDetail.volume"
								value="%{newDetail.volume}">
							</s:textfield>
						</tr>
						<tr>
							<s:textfield cssClass="odd" cssStyle="width: 480px;"
								label="Publisher" name="newDetail.publisher"
								value="%{newDetail.publisher}">
							</s:textfield>
							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="Edition" name="newDetail.edition"
								value="%{newDetail.edition}">
							</s:textfield>
						</tr>
						<tr>
							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="Author" name="newDetail.author"
								value="%{newDetail.author}">
							</s:textfield>
						</tr>
					</table>
					<table width="100%" class="subTable">
						...
						<tr>
							<s:textfield cssClass="odd" cssStyle="width: 680px;"
								label="Chapter/Article" name="newDetail.chapterArticle"
								value="%{newDetail.chapterArticle}">
								<s:param name="inputcolspan" value="%{5}" />
							</s:textfield>
						</tr>
						<tr>
							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="Page Range" name="newDetail.pageRange"
								value="%{newDetail.pageRange}">
							</s:textfield>
							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="No. of Copies" name="newDetail.numberOfCopies"
								value="%{newDetail.numberOfCopies}">
							</s:textfield>
							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="Line Item Ref #" name="newDetail.refNum"
								value="%{newDetail.refNum}">
							</s:textfield>
						</tr>
						<tr>

							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="No. of Pages" name="newDetail.numberOfPages"
								value="%{newDetail.numberOfPages}">
							</s:textfield>
							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="Est. no of Students" name="newDetail.estNumStudents"
								value="%{newDetail.estNumStudents}">
							</s:textfield>
							<s:textfield cssClass="odd" cssStyle="width: 80px;"
								label="Date of Issue" name="newDetail.dateOfIssue"
								value="%{newDetail.dateOfIssue}">
							</s:textfield>
						</tr>
					</table>
			</td>
...
<script type="text/javascript">
	...
	alert("in exit");
		...
		<s:url escapeAmp="false" action="viewOrderHistory"
								...
								<s:if test="selectedBundleNumber=-1">
							...
							var myUrl =	'<s:property value="#lnkConfNum"/>';
							alert("will navigate to " + myUrl);
	...
	alert("in add");
		$('#addDetail_addingDetail').val(true);
		//$('#search_buttons').hide();
