...
<s:form id="viewOrderTopMenu_form" theme="simple" action="viewInvoicedOrderHistory" namespace="/om/history" >
			...
			<td>
				<div
					...
					<div id="order_collapseheader">
						...
						<jsp:include
							page="/WEB-INF/jsp-modules-s2/ordermgmt/orderhistory/include/invoice/viewInvoiceHeader.jsp" />
              
					</div>

					<div id="clearer"></div>
						<jsp:include
							page="/WEB-INF/jsp-modules-s2/ordermgmt/orderhistory/include/invoice/viewInvoicedDetails.jsp" />
				</div>
			</td>
		</tr>
...
DETAILCOUNT=0;
_BASEFORM_='viewInvoicedOrderHistory';
_PAGINGDT_=<s:property value="pagingDetails"/>;
