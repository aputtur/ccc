						...
						<tr>
							...
							<td colspan="2">
								<s:if test="pagingDetails[individualDetailsIndex]">
								  <s:form theme="simple" id="viewOrderHistory%{individualDetailsIndex}" action="viewOrderHistory" method="post" namespace="/om/history">
									...
									<div style="display: inline; margins: 0px; padding: 0px;"
										id="order_<s:property value="selectedConfirmNumber"/>_course_<s:property value="bundle.bundleId"/>_details">
											<s:iterator value="wrappedResultsArray[individualDetailsIndex].detailsList" status="iterStatus">
