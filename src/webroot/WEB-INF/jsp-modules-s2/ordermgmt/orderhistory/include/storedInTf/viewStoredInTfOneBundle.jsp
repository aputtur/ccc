	...
	<div
		...
		<table class="editTable" style="margin-bottom: 0px;">
			<tr style="background-color: #E2E9F0;">
				...
				<td id="sectionHeader" valign="middle" style="height: 26px; width: 972px;">
							...
							<ul>
        				      ...
        				      <s:if test="haveDetailsStoredInOMS && !haveAdjustedDetails">
								<li id='course_<s:property value="bundle.bundleId"/>_edit_href'>
									<a class="detailAngleTabs" href="#"
										onclick="javascript:showCourseEdit('<s:property value="bundle.bundleId"/>','<s:property value="escapedCourseName"/>');return false;">Edit&nbsp;Section
									</a><span><img align="top" border="0" width="19" height="26"
											src="<s:url value="/resources/ordermgmt/images/spacer.gif"/>"></img>
									</span>
								</li>
		...
		<table>
			...
			<tr>
				<td>
					<div id="clearer"></div>
					<s:if test="(!pagingDetails && !myItems.empty) || (pagingDetails && !wrappedResults.detailsList.empty)">
						<jsp:include
								page="/WEB-INF/jsp-modules-s2/ordermgmt/orderhistory/include/storedInTf/viewStoredInTfBundleDetails.jsp" />
					</s:if>
				</td>
			</tr>
		</table>
