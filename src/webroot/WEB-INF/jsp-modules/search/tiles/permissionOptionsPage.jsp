...
function displayWait()
    {
 		setTimeout(function() {$(waiting_for_price).show();},1500);
    }
...
<logic:equal name="searchForm" property="isPPU" value="true">
	...
	<logic:notEmpty name="searchForm" property="rightsQualifyingStatement">
	    <div class="icon-alert" style="float:left;">
			<strong><bean:write name="searchForm" property="rightsQualifyingStatement" filter="false"/></strong>
	    </div><br/>
	</logic:notEmpty>
</logic:equal> 
 ...
 <div>
    <ul class="tabset">
    	 <logic:equal name="searchForm" property="isTraditionalPPUSelected" value="true">
    		<li class="active"><a  class="tab" onclick="toggle_vis(this,'pay_per_use_<%=wrkInst%>','annual_license_<%=wrkInst%>');return false;"><span><em>Pay Per Use Options</em></span></a></li>
    	 </logic:equal>
    	
    	<logic:equal name="searchForm" property="isLicenseSelected" value="true">
            <li class=""><a  class="tab" onclick="toggle_vis(this,'annual_license_<%=wrkInst%>','pay_per_use_<%=wrkInst%>');return false;"><span><em>Annual License Options</em></span></a></li>
        </logic:equal>
    </ul>
	...
	<logic:equal name="searchForm" property="isLicenseSelected" value="true">	
		<logic:equal name="searchForm" property="isTraditionalPPUSelected" value="true">	
			<div class="tab-content" id="annual_license_<%=wrkInst%>" style="display: none;">
				<logic:equal name="searchForm" property="isBiactive" value="true">
					<div class="title"><h4 style="font-size:14px">Publication year:&nbsp;<bean:write name="searchForm" property="selectedPubYear"/></h4>
					</div>
				</logic:equal>
				<tiles:insert page="/WEB-INF/jsp-modules/search/tiles/annualLicenseOptions.jsp"/>
			</div>
		</logic:equal>
		
		<logic:equal name="searchForm" property="isTraditionalPPUSelected" value="false">
			<div class="tab-content" id="annual_license_<%=wrkInst%>" style="display: block;">
				<logic:equal name="searchForm" property="isBiactive" value="true">
					<div class="title"><h4 style="font-size:14px">Publication year:&nbsp;<bean:write name="searchForm" property="selectedPubYear"/></h4>
					</div>
				</logic:equal>
