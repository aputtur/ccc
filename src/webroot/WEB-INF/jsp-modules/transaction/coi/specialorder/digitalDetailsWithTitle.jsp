...
<table border="0" class="indent-2">
  <tr>
    <td width="239"><em>Publication year of title being used</em>:<span class="Comment">*</span></td>
    <td><div align="left">
  ...
  <tr>
    ...
    <tr>
        ...
        <td><div align="left">
            <html:text name="specialOrderFormCOI" property="specialOrderItem.customAuthor" styleClass="normal" maxlength="250"/>
        </div></td>
    </tr>
    <tr>
