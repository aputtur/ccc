...
<iframe src="<html:rewrite page="/pages/62167c1239i93851aee9451eff4728944fbf8356.html"/>" id="helperIFrame" frameborder="0" scrolling="no" style="position: absolute; visibility: hidden; z-index:1000000; overflow: hidden;"></iframe>
<div id="calendarDiv" style="position:absolute; visibility:hidden; background-color:white; layer-background-color:white; z-index:100000000000000; "></div>

<h2 class="clearer indent-1"><strong>Publication Information:</strong></h2>

<table border="0" class="indent-2">
  <tr>
    <td>Publication name:<span class="importanttype"></span></td>
  ...
  <tr>
    <td>Edition:</td>
    <td><html:text name="specialOrderFormCOI" property="specialOrderItem.edition" styleClass="normal" maxlength="250"/></td>
  </tr>
</table>
