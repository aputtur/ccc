...
<table border="0" class="indent-2">
    <tr>
    <td width="220">Publication year of title being used:<span class="Comment">*</span></td>
        <td><div align="left">
    ...
    <tr>
        <td><div align="left">Page range(s):<span class="Comment">*</span></div></td>
        <td>
            <html:text name="specialOrderFormCOI" property="specialOrderItem.pageRange" styleClass="normal" size="48" maxlength="80" onchange="validatePageRange(this)"/>
    ...
    <tr>
        <td><div align="left">Number of students:<span class="Comment">*</span> </div></td>
        <td><div align="left">
    ...
    <tr>
        <td><div align="left">Author/Editor:<span class="Comment">*</span></div></td>
        <td><div align="left">
            <html:text name="specialOrderFormCOI" property="specialOrderItem.customAuthor" styleClass="normal" size="48" maxlength="250"/>
        </div></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><div align="left">
            <html:text name="specialOrderFormCOI" property="specialOrderItem.customVolume" styleClass="normal" size="48" maxlength="250"/>
        </div></td>
    </tr>
    <tr>
        <td><div align="left">Edition:</div></td>
        <td><div align="left">
            <html:text name="specialOrderFormCOI" property="specialOrderItem.customEdition" styleClass="normal" size="48" maxlength="250"/>
        </div></td>
    </tr>
    <tr>
        <td><div align="left">Your line item reference: </div></td>
        <td>
            <html:text name="specialOrderFormCOI" property="specialOrderItem.customerReference" styleClass="normal" size="48" maxlength="50"/>
            <span class="smalltype">(Example: prosmith456-1) </span>
        </td>
    </tr>
</table>