...
<bean:define id="item" name="rightsLinkQuickPriceActionForm" property="selectedPubItem" />

<h2><bean:write name="rightsLinkQuickPriceActionForm" property="selectedPubItem.mainTitle"/></h2>

<div class="biblo_left" style="float:left;width:350px;">
