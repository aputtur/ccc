                ...
                <ul class="list">
                	...
                	<logic:equal name="item" property="rightsLink" value="true">
                			<logic:equal name="skipItemForDebug" value="false">
		                		...
		                		<li class="jobTicket"><strong>Job Ticket: </strong>
			                                   		<span><bean:write name="item" property="jobTicketNumber" /></span>
			                   </li>
			                   </logic:notEmpty>
		                   <logic:notEmpty name="item" property="externalDetailId">
		                   <li class="jobTicket">
		                   <strong>Order License Id: </strong>
		                     	            		<span><bean:write name="item" property="externalDetailId" /></span>
		                     </li> 
		                     </logic:notEmpty>
	                     </logic:equal>
                 ...
                 <logic:notEmpty name="item" property="categoryName">
                                         ...
                                         <bean:define id="viewDetailsId" >
                                             ...
                                             <bean:define id="displayBlock">none</bean:define>
                                         		<logic:equal name="processType" value="PRINT">
                                               <bean:define id="displayBlock">block</bean:define>
                                              </logic:equal>
                                        		 <logic:notEqual name="processType" value="PRINT">
                                        			 <bean:define id="displayBlock">none</bean:define>
                                         			</logic:notEqual>
                     ...
                     <logic:notEmpty name="item" property="rightsQualifyingStatement">
			              ...
			              <logic:empty name="item" property="rightsQualifyingStatement">                                
			              		<logic:notEmpty name="item" property="externalCommentTerm">
                            	    <p><b>Rightsholder terms apply </b>(see terms and conditions)</p>
                            	</logic:notEmpty>
                            </logic:empty>
			<p></p>
  					      <logic:equal name="item" property="rightsLink" value="true">
