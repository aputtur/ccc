...
<h2>Confirmation Number: <bean:write name="reviewTermsActionFormCOI" property='confirmNumber'/></h2>
</td>
</tr>
<tr><td>
...
<logic:equal name="reviewTermsActionFormCOI" property="hasTerms" value="true">

<div class="callout-light">

    
  <logic:iterate name="reviewTermsActionFormCOI" property="terms" id="item" indexId="idx" type="OrderLicense">
...
<logic:notEqual name="reviewTermsActionFormCOI" property="hasTerms" value="true">
<div class="callout-light">
