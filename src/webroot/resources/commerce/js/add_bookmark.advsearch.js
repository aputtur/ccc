...
var addBookmarkObj = {
  linkText:'Bookmark this page with these permission types...',
  title:document.title,
  URL:location.href,
  getTextLink:function(parId) {
  ...
  makeLink:function(parId,isText){
    ...
    if(window.external && isMSIE && !isIEmac){
      ...
      a.onclick=function(){ // IE/Win
    	 ...
    	 href=protocol+ "//" + host +"/search.do?operation=show&page=advanced&permSel="
    	 ///search.do?operation=show&page=advanced&permSel=//
    	 // remove between first occurance of // and first occurance of / http://xxxxx/
    	 
    	 
    	 if (href.indexOf('&permSel=')) {
    		 href=href.replace(/&permSel=.*$/,"");
    	 }
    	 href=href+'&permSel='+getSelectedPermissions();
        //try {
          window.external.AddFavorite(href,addBookmarkObj.title);
        //} catch(ex){
      ...
      a.onclick=function(){
        var href=this.href;
    	  ...
    	  this.href=href+'&permSel='+getSelectedPermissions();
    	  return true;
      }
...
jQuery(document).ready(
		function() {
			addBookmarkObj.URL=location.href.replace(/\?.*$/,'?operation=show&page=advanced');
