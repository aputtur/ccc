...
abstract public PermissionRequest getPermissionRequest();
  ...
  abstract void setWorkId( String workId );
  abstract void setWhichWork(String whichWork );
  ...
  abstract public void setRightFromWeb(RightAdapter rightAdapter);
  
  abstract public Item getItem();
  abstract public String getPreviewPDFUrl ();
  
  abstract public WRStandardWork getWork();
