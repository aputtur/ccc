 ...
 * @created 30-Oct-2006
 */
final class PublicationPermissionSearchResultImpl implements PublicationPermissionSearchResult, Serializable {
    ...
    protected PublicationPermissionSearchResultImpl() {
        _publications = null;
