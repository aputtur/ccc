 ...
 */
public class OverdueInvoiceResultTypeDTO extends OverdueInvoiceResultTypeImpl implements DTOWithNesting
{
	 ...
	 */
	private static DTO _dto = new OverdueInvoiceResultTypeDTO();

	/**
	 * Name of the custom Oracle object type represented by this java class.
	 */
	private static final String ORACLE_TYPE = "CCC_OVERDUE_INVOICES_TYPE";
	 ...
	 */
	private static final DTOMap DTO_MAP = new DTOMap(ORACLE_TYPE, OverdueInvoiceResultTypeDTO.class);
	 ...
	 * Null constructor.
	 */
	public OverdueInvoiceResultTypeDTO()
	{
		super();
	}
	...
	{
		return new DTO[] { new OverdueInvoiceDTO() };
	...
	public final void readSQL(SQLInput stream, String typeName) throws SQLException
	{
		...
		setOverdueInvoices((OverdueInvoiceDTO[]) SQLUtils.readDTOArray(stream, OverdueInvoiceDTO.class));
	...
	{
		throw new NotImplementedException(OverdueInvoiceResultTypeDTO.class);
	}
}
