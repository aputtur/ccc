...
/**
 * Data Transfer Object for the <code>IAutoDunningParam</code> object.
 */
public class AutoDunningParamResultTypeDTO extends AutoDunningParamResultTypeImpl implements DTOWithNesting
{
	 ...
	 */
	private static DTO _dto = new AutoDunningParamResultTypeDTO();

	/**
	 * Name of the custom Oracle object type represented by this java class.
	 */
	private static final String ORACLE_TYPE = "CCC_AUTODUNNING_PARAMS_TYPE";

	/**
	 * Name of the custom Oracle object type that contains a table of instances represented by this java class.
	 */
	 ...
	 */
	private static final DTOMap DTO_MAP = new DTOMap(ORACLE_TYPE, AutoDunningParamResultTypeDTO.class);
	 ...
	 * Null constructor.
	 */
	public AutoDunningParamResultTypeDTO()
	{
		super();
	}
	...
	{
		return new DTO[] { new AutoDunningParamDTO() };

	}

	/**
	 * Implementation of <code>SQLData.readSQL()</code>. Allows transfer of data from Oracle object type to java object.
	 */
	public final void readSQL(SQLInput stream, String typeName) throws SQLException
	{

		setAutoDunningParams((AutoDunningParamDTO[]) SQLUtils.readDTOArray(stream, AutoDunningParamDTO.class));

	}

	/**
	 * Implementation of <code>SQLData.writeSQL()</code>. Allows transfer of data from java object to Oracle object
	 * type.
	 */
	public final void writeSQL(SQLOutput stream) throws SQLException
	{
		throw new NotImplementedException(AutoDunningParamResultTypeDTO.class);
	}
}
