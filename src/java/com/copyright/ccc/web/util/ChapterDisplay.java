...
public class ChapterDisplay  implements Serializable{
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private WorkExternal work;
	public ChapterDisplay(WorkExternal work){
		this.work = work;
	}
	...
	public String getIdnoTypeCd() {
		 ...
		 */
		if (work.getIdnoTypeCd() == null) {
			return null;
		}
		if (work.getIdnoTypeCd() != null && work.getIdnoTypeCd().equals(IdnoTypeCdEnum.WRWRKINST)) {
			return "CCC System Number";
		}
		return work.getIdnoTypeCd().name();
	}
